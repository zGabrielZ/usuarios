...
INSERT INTO TB_PERFIL(TITULO, AUTORIEDADE) VALUES ('Administrador', 'ROLE_ADMIN');
...
INSERT INTO TB_USUARIO(NOME, EMAIL, CPF, RENDA, DATA_NASCIMENTO, QUANTIDADE_FILHOS, ID_TELEFONE, ID_GENERO, CREATED_AT, SENHA) VALUES ('Nome teste', 'teste@email.com', '63801219003', 10000, '1990-03-06', 1, 1, 1, NOW(), '$2a$10$D8mPWP4sgNSTc3ILA5nRM.dB3HmWbNOFuZN7tPuraETok4s9HPOry');
...
INSERT INTO TB_ANOTACAO(TITULO, DESCRICAO, ID_USUARIO, ID_TIPO_ANOTACAO, ID_SITUACAO_TIPO_ANOTACAO, CREATED_AT, DATA_LEMBRETE) VALUES ('Lembrete', 'Lembrete....', 1, 8, 13, NOW(), NOW());
INSERT INTO TB_ANOTACAO(TITULO, DESCRICAO, ID_USUARIO, ID_TIPO_ANOTACAO, ID_SITUACAO_TIPO_ANOTACAO, CREATED_AT, DATA_ESTUDO_INICIO, DATA_ESTUDO_FIM) VALUES ('Estudo', 'Estudo....', 1, 7, 9, NOW(), NOW(), NOW());

INSERT INTO TB_TELEFONE(NUMERO, DDD, DESCRICAO, ID_TIPO_TELEFONE, CREATED_AT) VALUES ('999999999', '11', 'telefone teste 2', 5, NOW());

INSERT INTO TB_USUARIO(NOME, EMAIL, CPF, RENDA, DATA_NASCIMENTO, QUANTIDADE_FILHOS, ID_TELEFONE, ID_GENERO, CREATED_AT, SENHA) VALUES ('Nome teste 2', 'teste2@email.com', '23634246030', 20000, '1985-11-04', 1, 2, 1, NOW(), '$2a$10$D8mPWP4sgNSTc3ILA5nRM.dB3HmWbNOFuZN7tPuraETok4s9HPOry');
INSERT INTO TB_USUARIO_PERFIL(ID_USUARIO, ID_PERFIL) VALUES (2, 2);

INSERT INTO TB_ANOTACAO(TITULO, DESCRICAO, ID_USUARIO, ID_TIPO_ANOTACAO, ID_SITUACAO_TIPO_ANOTACAO, CREATED_AT) VALUES ('Rascunho 2', 'Rascunho....2', 2, 6, 11, NOW());